...
export const proofs: Record<Lang, ProofCopy> = {
  ...
  en: {
    ...
    lead:
      "The token is a verified plain ERC-20. There is no mint, owner, pause, tax, blacklist, or upgradeable proxy. Behaviour cannot be changed after deploy.",
    liveSupply: "On-chain total supply",
    liveOwner: "owner()",
    liveOwnerYes: "Owner present.",
    liveOwnerNo: "No owner.",
    items: [
      {
        t: "Fixed supply",
        b: "Minted once at genesis. No mint(). Total supply is 1,618,033,988 KAI.",
      },
      {
        t: "Fixed name",
        b: "Name: Kai. Symbol: KAI. There is no function to rename the token.",
      },
      {
        t: "No token admin",
        b: "Not Ownable. owner() reverts. No pause, blacklist, or tax.",
      },
      {
        t: "Not upgradeable",
        b: "No proxy. Contract logic is final.",
      },
      {
        t: "Presale parameters",
        b: "Payment asset and treasury address are immutable. Purchase records cannot decrease. The sale opens once; closing cannot be reversed.",
      },
    ],
    teamT: "Team vesting",
    team:
      "Team allocation is 5% of total supply. Nothing unlocks at TGE. A 12-month cliff is followed by 60 months linear release.",
  ...
  de: {
    ...
    teamT: "Team-Vesting",
    team: "Team-Anteil 5 % der Gesamtmenge. Beim TGE keine Freigabe. 12 Monate Cliff, danach 60 Monate linear.",
  ...
  es: {
    ...
    teamT: "Vesting del equipo",
    team: "El equipo recibe el 5 % de la oferta. En el TGE no se libera nada. Cliff de 12 meses y liberación lineal en 60 meses.",
    verify: "Verifícalo",
    tokenLink: EX_TOKEN,
    saleLink: EX_SALE,
  },
  fr: {
    ...
    teamT: "Vesting équipe",
    team: "Allocation équipe : 5 % de l’offre. Rien n’est libéré au TGE. Cliff de 12 mois, puis linéaire sur 60 mois.",
    verify: "Vérifiez",
    tokenLink: EX_TOKEN,
    saleLink: EX_SALE,
  },
  it: {
    ...
    teamT: "Vesting del team",
    team: "Allocazione team: 5 % dell’offerta. Al TGE non si sblocca nulla. Cliff di 12 mesi, poi lineare in 60 mesi.",
    verify: "Verifica",
    tokenLink: EX_TOKEN,
    saleLink: EX_SALE,
  },
  pt: {
    ...
    teamT: "Vesting da equipe",
    team: "Alocação da equipe: 5 % da oferta. Nada é liberado no TGE. Cliff de 12 meses e liberação linear em 60 meses.",
    verify: "Verifique",
    tokenLink: EX_TOKEN,
    saleLink: EX_SALE,
  },
  ru: {
    ...
    teamT: "Вестинг команды",
    team: "Доля команды — 5 % эмиссии. На TGE ничего не открывается. Клифф 12 месяцев, затем линейно 60 месяцев.",
